...
CREATE TABLE `commissions` (
  ...
  KEY `commission_amount_index` (`commission_amount`),
...
INSERT INTO `employees` VALUES (1,'Chris Gayle',1000000,1),(2,'Michael Clarke',800000,2),(3,'Rahul Dravid',700000,1),(4,'Rickey Pointing',600000,2),(5,'Albie Morkel',650000,2),(6,'Wasim Akram',750000,3);
...
-- Dump completed on 2017-09-02 16:15:27
